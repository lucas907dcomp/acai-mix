        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {sales.map((sale) => {
              ...
              const isUnitSale = sale.products?.product_type === 'unit' || sale.weight_grams === 0
              return (
                <tr
                  key={sale.id}
                ...
                >
                  ...
                  <td className="px-4 py-3 text-white">
                    ...
                    {sale.quantity && sale.quantity > 1 && (
                      <span className="ml-1 text-xs text-[#9d7bc8]">×{sale.quantity}</span>
                    )}
                  </td>
                  <td className="px-4 py-3 text-[#9d7bc8]">
                    {isUnitSale ? '—' : `${sale.weight_grams}g`}
                  </td>
                  <td className="px-4 py-3 text-white">
            ...
            <div className="space-y-3 py-1">
              ...
              <div className="rounded-lg bg-[#0f0720] border border-[#2d1550] p-3 space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{confirmSale.products?.name ?? '—'}</span>
                </div>
                {confirmSale.weight_grams > 0 && (
                  <div className="flex justify-between">
